...
namespace FotoFly.Geotagging.Resolvers
{
    ...
    public class ResolverCache
    {
        ...
        public ResolverCache(string cacheDirectory, string cacheName)
        {
            ...
            this.cacheForwardFileName = this.cacheDirectory + filePrefix + "_Forward.log";
            this.cacheReverseFileName = this.cacheDirectory + filePrefix + "_Reverse.log";
            this.failedReverseFileName = this.cacheDirectory + filePrefix + "_ReverseFailed.log";
            this.failedForwardFileName = this.cacheDirectory + filePrefix + "_FowardFailed.log";
